...
class OnderhoudController extends Controller
{
	...
	public function actionCreate($id)
	{
		...
		if(isset($_POST['Onderhoud']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idtbl_onderhoud));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Onderhoud');
	...
	{
		$model=new Onderhoud('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Onderhoud']))
			$model->attributes=$_GET['Onderhoud'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='onderhoud-form')
		{
